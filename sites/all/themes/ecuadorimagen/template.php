 ...
 * @see html.tpl.php
 */
function ecuadorimagen_preprocess_html(&$variables) {
  // Add conditional stylesheets for IE
  $theme_path = drupal_get_path('theme', 'ecuadorimagen');
 ...
 */
function ecuadorimagen_css_alter(&$css) {
  global $language;
 ...
 * Preprocess field.
 */
function ecuadorimagen_preprocess_field(&$variables) {
 ...
 */
function ecuadorimagen_preprocess_node(&$variables) {
